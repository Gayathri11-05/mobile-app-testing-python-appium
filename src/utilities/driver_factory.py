...
from src.config.capabilities import Capabilities
from src.utilities.logger import Logger


class DriverFactory:
    """
    Factory class for creating and managing Appium driver instances. This class handles driver initialization and cleanup for both
