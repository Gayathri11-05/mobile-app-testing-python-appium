...
class Capabilities:
    """
    Capabilities manager for Android and iOS devices. This class provides device-specific capabilities required
    ...
    def get_android_capabilities():
        """
        Get Android device capabilities, returns dict: Android capabilities dictionary
        """
        return {
    ...
    def get_ios_capabilities():
        """
        Get iOS device capabilities,returns dict: iOS capabilities dictionary
        """
        return {
            "platformName": "iOS",
    ...
    def get_capabilities():
        """
        Get platform-specific capabilities based on configuration, returns: dict: Capabilities dictionary for current platform
        """
